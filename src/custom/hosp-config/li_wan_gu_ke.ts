...
const config = {
  ...
  subscribes: {
    checkReminder: '1Y7Iu0-grEtMsexRhqB1Q4cHgTspOggU5Y6bhufypaI', // 审方提醒 长期订阅
    pendingPayReminder: 'nJMfTeNcCIRAOC3agtrH2sEw_rb9MQXVC2eK0dEJgvM',// 待缴费提醒 长期订阅
    visitReminder: '4RckgEP-B5zFYHkMDdrSvmB1unuU7LDhH9ZGf4MJ0eI', // 就诊提醒 长期订阅
